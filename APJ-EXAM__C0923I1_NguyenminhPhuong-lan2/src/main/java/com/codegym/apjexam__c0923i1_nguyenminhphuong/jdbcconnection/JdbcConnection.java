package com.codegym.apjexam__c0923i1_nguyenminhphuong.jdbcconnection;
...
public class JdbcConnection {
    ...
    private static final String CONN_URL = "jdbc:mysql://localhost:3306/apj_thuchanh_module3";
